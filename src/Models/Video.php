...
class Video extends Model
{
    ...
    /**
     * Signed URL expiry duration for private videos (7 days in minutes).
     */
    ...
    public function getUrlAttribute(): string
    {
        ...
        // Return signed URL for private videos if driver supports it (S3, etc.)
        try {
